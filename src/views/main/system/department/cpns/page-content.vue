<template>
  <div class="user-content">
    <div class="content">
      <div class="header">
        <h3>部门列表</h3>
        <el-button type="primary" @click="handelNuwUserClick">新建部门</el-button>
      </div>
      <div class="table">
...
function fetchpageListData(args: any = {}) {
  ...
  //2.发送网络请求
  userListStore.fetchPostPageList('department', queryinfo)
}
defineExpose({ fetchpageListData })
//5.编辑和删除操作
//1.删除操作
function handDeleteClick(id: number) {
  userListStore.fetchDeletePageData('department', id)
}
//2.编辑操作
